...
**Fix:** Run script from `langchain/` directory:
```bash
cd langchain/
python scripts/02_run_pipeline.py --test
```
...
- [engine.md](../src/ontology_selection/engine.md): Pipeline specification
